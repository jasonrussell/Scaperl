...
# Welcome :)
my $VERSION = "0.1";
my $welcome = "Welcome to Scaperl ($VERSION) Copyright 2006 Sylvain SARMEJEANNE\nIf you're lost, just shout for \"help\".\n";
print $welcome;
...
our @DISSECTOR_LIST = qw(Ether IP ICMP TCP UDP Raw ClassicBSDLoopback OpenBSDLoopback);
